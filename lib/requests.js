 ...
 */
function getListOfStarredRepos() {
 ...
 * @param {String} accountFrom Which account to transfer stars FROM. Either "current" by default, or "new".
 */
function transferStars(accountFrom = 'current') {
  if (accountFrom === 'current') {
    // First, get list of starred repos for both account
